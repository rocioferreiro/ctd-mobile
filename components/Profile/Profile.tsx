...
export function Profile(props: Props) {
  ...
  const getActiveChallenge = (challenge, key) => {
    ...
    return <TouchableOpacity onPress={() => props.navigation.navigate('tabbar',{screen:'challenges-scrollview' ,params: {challengeId: challenge.id, challenges:challengesData.getCreatedChallengesByUser,key:{key}}})} style={{backgroundColor: 'transparent', marginRight: 20}} key={key}>
