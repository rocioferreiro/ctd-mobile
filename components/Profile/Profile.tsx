...
export function Profile(props: Props) {
  ...
  const getActiveChallenge = (challenge, key) => {
    ...
    return <TouchableOpacity onPress={() => props.navigation.navigate('challenges-scrollview', {challengeId: challenge.id,challenges:challengesData.getCreatedChallengesByUser})} style={{backgroundColor: 'transparent', marginRight: 20}} key={key}>
